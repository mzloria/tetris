...
public class GUITetrisPanel extends JPanel implements ActionListener
{
    ...
    private static final double DELAY_MUTIPLIER = 0.75;
    ...
    /** Draw grid boolean value. */
    private boolean myDrawGrid;
    
    /** The current color of the blocks. */
    ...
    {
        myCurrentBlockColor = Color.BLUE;
    ...
    public void paintComponent(final Graphics theGraphics)
    {
        ...
        if (myDrawGrid)
        {
            ...
            {
                g2d.drawLine(myHorizontalOffset + mySquareSize * i, 
                             myVerticalOffset, 
                             myHorizontalOffset + mySquareSize * i, 
                             this.getSize().height - myHorizontalOffset);
            }    
            for (int i = 0; i < COLUMN_BLOCKS; i++)
            {
                g2d.drawLine(myHorizontalOffset, 
                             myVerticalOffset + mySquareSize * i, 
                             this.getSize().width - myHorizontalOffset, 
                             myVerticalOffset + mySquareSize * i);
            }         
        }
        if (myBoardStrings != null)
        {
            ...
            { 
                for (int j = 0; j < NUM_BLOCKS; j++)
                {
                    ...
                    {
                        g2d.setColor(myCurrentBlockColor);
    ...
    /**
     * Speeds up the game by setting the current delay to
     * three-fourths of the previous delay.
     */
    protected void speedUp()
    {
        myTimer.setDelay((int) (DELAY_MUTIPLIER * myTimer.getDelay()));
    }
     ...
     * 
     * @return The current block color.
     */
    protected Color getCurrentBlockColor()
    {
        return myCurrentBlockColor;
    }
    
    /**
     * Sets the current block color.
     * 
     * @param theCurrentBlockColor The color that the blocks will be set to.
     */
    protected void setCurrentBlockColor(final Color theCurrentBlockColor)
    {
        myCurrentBlockColor = theCurrentBlockColor;
    }
