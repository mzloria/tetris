...
public class Board
{
    ...
    /**
     * This method returns a String representation of the Board including the
     * current piece and all frozen blocks.
     * 
    ...
    private MovableTetrisPiece nextMovablePiece(final boolean theRestart)
    {
        ...
        final MovableTetrisPiece nextMovablePiece =
                        new MovableTetrisPiece(next,
                                               new Point((myWidth - myNextPiece.getWidth())
                                                         / 2, startY));
        ...
        if (!myGameOver)
        {
            ...
            final MovableTetrisPiece nextToDisplay =
                            new MovableTetrisPiece(myNextPiece,
                                                   new Point((myWidth - next.getWidth()) / 2,
                                                             startY));
